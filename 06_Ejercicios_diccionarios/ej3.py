...
# precios de las distintas frutas. El programa pedirá el nombre de la fruta y la cantidad que se
# ha vendido y nos mostrará el precio final de la fruta a partir de los datos guardados en el
...
while True:
    fruta = input("Fruta que has vendido: ")
    if fruta.lower() not in precios:
        print("Fruta no existe.")
    else:
        cantidad = int(input("Cantidad de frutas que has vendido: "))
