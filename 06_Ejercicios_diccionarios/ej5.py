...
#   teléfono y, opcionalmente, permitir modificarlo si no es correcto. Si el nombre no se
#   encuentra, debe permitir ingresar el teléfono correspondiente.
# - Buscar: Nos pide una cadena de caracteres, y nos muestras todos los contactos cuyos
