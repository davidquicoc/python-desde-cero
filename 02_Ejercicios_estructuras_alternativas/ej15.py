...
# 
# si son 100 alumnos o más, el costo por cada alumno es de 65 euros; de 50 a 99 alumnos, el costo
# es de 70 euros, de 30 a 49, de 95 euros, y si son menos de 30, el costo de la renta del
...
num_alumnos = int(input("Nº de alumnos: "))
...
if num_alumnos>0:
	...
	print("El coste por alumno es %.2f%s" % (coste_por_alumno,"€"))
	print("El coste del autobús es %.2f%s" % (coste_autobus,"€"))
else:
