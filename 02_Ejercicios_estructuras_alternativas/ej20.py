...
if peso > 0 and peso <= 5000:
    ...
    if zona == 1: print("Coste: ",peso*24, "€", sep="")
    elif zona == 2: print("Coste: ",peso*20, "€", sep="")
    elif zona == 3: print("Coste: ",peso*21, "€", sep="")
    elif zona == 4: print("Coste: ",peso*10, "€", sep="")
    elif zona == 5: print("Coste: ",peso*18, "€", sep="")
